...
const projects = [
  ...
  },
  {
    ...
    description:
      'A modern Android music player built in Kotlin — local library scanning, playlist management, waveform visualizer, and Material You design.',
    tech: ['Kotlin', 'Media3', 'Room DB', 'Material3', 'Coroutines'],
    color: '#a78bfa',
  ...
  },
  {
    ...
    description:
      'Upload any PDF and chat with it using AI. Semantic search over document chunks, streaming responses, and a clean chat interface.',
    tech: ['React', 'Node.js', 'OpenAI API', 'Pinecone', 'Firebase'],
    color: '#60a5fa',
            ...
            <div key={i} className={`project-card reveal delay-${i + 1}`}>
              ...
              <div className="project-body">
                ...
                <div className="project-actions">
                  <a href={p.demo} className="project-btn-primary" style={{ background: p.color }}>
                    Live Demo
